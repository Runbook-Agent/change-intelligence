  ...
  paths: {
    ...
    '/api/v1/change-sets': {
      get: {
        ...
        summary: 'List grouped change sets',
        description: 'Groups related events into deployment/release-style change sets with readiness and evidence summaries.',
        parameters: [
          { name: 'since', in: 'query', schema: { type: 'string', format: 'date-time' } },
          { name: 'until', in: 'query', schema: { type: 'string', format: 'date-time' } },
          { name: 'services', in: 'query', schema: { type: 'string' }, description: 'Comma-separated service names' },
          { name: 'limit', in: 'query', schema: { type: 'integer', default: 200 } },
          { name: 'bucket_minutes', in: 'query', schema: { type: 'integer', default: 15 } },
        ],
        responses: {
          '200': {
            description: 'Grouped change sets',
            content: { 'application/json': { schema: { $ref: '#/components/schemas/ChangeSetListResponse' } } },
          },
        },
      },
    },
    ...
    '/api/v1/triage': {
      post: {
        ...
        summary: 'Single-call incident triage',
        description: 'Returns top related change sets with evidence, why-relevant factors, confidence breakdowns, and blast-radius previews.',
        requestBody: {
          required: true,
          content: { 'application/json': { schema: { $ref: '#/components/schemas/TriageRequest' } } },
        },
        responses: {
          '200': { description: 'Triage results', content: { 'application/json': { schema: { $ref: '#/components/schemas/TriageResponse' } } } },
          '400': { description: 'Validation error', content: { 'application/json': { schema: { $ref: '#/components/schemas/StructuredError' } } } },
        },
      },
    },
    ...
    schemas: {
      ChangeEvent: {
        ...
        properties: {
          ...
          authorType: { type: 'string', enum: ['human', 'ai_assisted', 'autonomous_agent'] },
          reviewModel: { type: 'string' },
          humanReviewCount: { type: 'integer' },
          testSignal: { type: 'string', enum: ['passed', 'failed', 'partial', 'unknown'] },
      ...
      BlastRadiusPrediction: {
        ...
        properties: {
          ...
          highConfidenceDependents: { type: 'array', items: { type: 'string' } },
          possibleDependents: { type: 'array', items: { type: 'string' } },
          ...
          impactPaths: {
            ...
            items: {
              ...
              properties: {
                ...
                edgeSources: { type: 'array', items: { type: 'string' } },
          ...
          confidenceSummary: {
            ...
            properties: {
              ...
              possibleCount: { type: 'integer' },
            },
          },
          evidence: { type: 'array', items: { $ref: '#/components/schemas/EvidenceLink' } },
      ...
      CorrelateRequest: {
        ...
        properties: {
          ...
          incident_environment: { type: 'string' },
          window_minutes: { type: 'number' },
          max_results: { type: 'number' },
          min_score: { type: 'number' },
          include_change_sets: { type: 'boolean' },
        },
      },
      CorrelateResponse: {
        type: 'object',
        properties: {
          ...
          changeSets: { type: 'array', items: { $ref: '#/components/schemas/TriageCandidate' } },
          change_sets: { type: 'array', items: { $ref: '#/components/schemas/TriageCandidate' } },
          query: { type: 'object' },
        },
      },
      ChangeCorrelation: {
      ...
      ConfidenceBreakdown: {
        ...
        properties: {
          ...
          factors: {
            type: 'object',
            properties: {
              timeProximity: { type: 'number' },
              serviceAdjacency: { type: 'number' },
              changeRisk: { type: 'number' },
              changeType: { type: 'number' },
              environmentMatch: { type: 'number' },
            },
          },
        },
      },
      ReadinessDelta: {
        type: 'object',
        properties: {
          runbookUpdated: { type: 'string', enum: ['updated', 'missing', 'unknown'] },
          monitoringUpdated: { type: 'string', enum: ['updated', 'missing', 'unknown'] },
          ownershipKnown: { type: 'string', enum: ['updated', 'missing', 'unknown'] },
      ...
      ChangeSet: {
        ...
        properties: {
          ...
          authorTypes: { type: 'array', items: { type: 'string' } },
          evidence: { type: 'array', items: { $ref: '#/components/schemas/EvidenceLink' } },
          readinessDelta: { $ref: '#/components/schemas/ReadinessDelta' },
          confidence: { type: 'number' },
        },
      },
      TriageCandidate: {
        ...
        properties: {
          ...
          confidence: { $ref: '#/components/schemas/ConfidenceBreakdown' },
          evidence: { type: 'array', items: { $ref: '#/components/schemas/EvidenceLink' } },
          suggestedBlastRadius: { $ref: '#/components/schemas/BlastRadiusPrediction' },
        },
      },
      TriageRequest: {
        type: 'object',
      ...
      TriageResponse: {
        ...
        properties: {
          ...
          symptomTags: { type: 'array', items: { type: 'string' } },
          topChangeSets: { type: 'array', items: { $ref: '#/components/schemas/TriageCandidate' } },
          correlations: { type: 'array', items: { $ref: '#/components/schemas/ChangeCorrelation' } },
        },
      },
      ...
      AgentWebhookPayload: {
        ...
        properties: {
          ...
          author_type: { type: 'string', enum: ['human', 'ai_assisted', 'autonomous_agent'] },
          review_model: { type: 'string' },
          human_review_count: { type: 'integer' },
          test_signal: { type: 'string', enum: ['passed', 'failed', 'partial', 'unknown'] },
